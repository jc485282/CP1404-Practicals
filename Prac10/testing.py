...
def is_formatted(word):
    """
    Check phrase as a sentence - starting with a capital and ending with a single full stop
    >>> is_formatted("hello")
    False
    >>> is_formatted('It is an ex parrot.')
    True
    >>> is_formatted('i have some idea of what i am doing.')
    False
    """

    return word[0].isupper() and word.endswith(".")
